...
- `configuration` contains UI configuration. All details you can find [here](https://github.com/Banuba-Examples/ve-sdk-ios-integration-sample/blob/main/mdDocs/gallery_styles.md)
